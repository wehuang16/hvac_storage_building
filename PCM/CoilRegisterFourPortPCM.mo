...
model CoilRegisterFourPortPCM
  ...
  replaceable parameter hvac_storage_building.PCM.Data.SunampQ6HeatExchanger
    Design "Design of HX";
  hvac_storage_building.PCM.BaseClasses.HexElementSensibleFourPort eleHex(
    ...
    heatExchangerScalingFactor=heatExchangerScalingFactor)
  ...
  Modelica.Blocks.Interfaces.RealOutput QLPC
    "convective heat flow from LPC [W]" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={110,66})));
  Modelica.Blocks.Sources.RealExpression calcSOC(y=hvac_storage_building.PCM.Functions.SOC(
        Upcm=eleHex.Upcm,
        mpcm=eleHex.mpcm,
  ...
  Modelica.Blocks.Sources.RealExpression calcTesCap(y=hvac_storage_building.PCM.Functions.Ufg(
                                                                    mpcm=eleHex.mpcm,
        LHea=Design.PCM.LHea))
  ...
  Modelica.Blocks.Interfaces.RealOutput TPCM "Connector of Real output signal"
    annotation (Placement(transformation(extent={{100,-8},{120,12}}),
        iconTransformation(extent={{112,-10},{132,10}})));
...
equation
  ...
  connect(eleHex.Tpcm, TPCM) annotation (Line(points={{12.96,0},{96,0},{96,2},{
          110,2}}, color={0,0,127}));
  connect(eleHex.heaPorOutside, heaPorOutside) annotation (Line(points={{12.72,
          -12},{12.72,-118},{106,-118}}, color={191,0,0}));
  annotation (
