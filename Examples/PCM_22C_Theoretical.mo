...
model PCM_22C_Theoretical "Tes storage implementation"
...
parameter Modelica.Units.SI.MassFlowRate mPCM_flow_nominal=0.3;
  ...
  PCM.CoilRegisterFourPortPCM coilRegisterFourPortPCM(
    ...
    Design(
      ...
      PCM(
        k=sunampQ6MaterialProperties.kPCMPas,
        c=sunampQ6MaterialProperties.cPCMPas,
        d=sunampQ6MaterialProperties.dPCMPas,
        TSol=sunampQ6MaterialProperties.TSolPas,
        TLiq=sunampQ6MaterialProperties.TLiqPas,
        LHea=sunampQ6MaterialProperties.LHeaPas)),
