...
model PCM_58C_Theoretical "Tes storage implementation"
...
parameter Modelica.Units.SI.MassFlowRate mPCM_flow_nominal=0.3;
  ...
  PCM.CoilRegisterFourPortPCM coilRegisterFourPortPCM(
    ...
    Design(
      ...
      PCM(
        k=sunampQ6MaterialProperties.kPCMHig,
        c=sunampQ6MaterialProperties.cPCMHig,
        d=sunampQ6MaterialProperties.dPCMHig,
        TSol=sunampQ6MaterialProperties.TSolHig,
        TLiq=sunampQ6MaterialProperties.TLiqHig,
        LHea=sunampQ6MaterialProperties.LHeaHig)),
