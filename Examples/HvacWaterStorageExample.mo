...
equation
  ...
  connect(sin.y, hvacWaterStorage.ZonLoaReq[1]) annotation (Line(points={{-50,-44},
          {-12,-44},{-12,-4},{-4,-4},{-4,-1.83333},{0.518519,-1.83333}},
                                                                  color={0,0,
          127}));
  connect(con1.y, hvacWaterStorage.ZonLoaReq[2:6]) annotation (Line(points={{
          -26,-86},{-10,-86},{-10,-4},{-4,-4},{-4,-0.166667},{0.518519,
          -0.166667}}, color={0,0,127}));
  annotation (
