...
model PCM_11C_Experimental "Tes storage implementation"
...
parameter Modelica.Units.SI.MassFlowRate mPCM_flow_nominal=0.3;
  ...
  PCM.CoilRegisterFourPortPCM coilRegisterFourPortPCM(
    heatExchangerScalingFactor=0.03,
    m1_flow_nominal=mPCM_flow_nominal/2,
    m2_flow_nominal=mPCM_flow_nominal/2,
    TStart_pcm=288.15,
    Design(
      Tes_nominal(displayUnit="kWh") = 4860000,
      dp1_nominal=dpHPC_nominal,
      dp2_nominal=dpLPC_nominal,
      PCM(
        k=sunampQ6MaterialProperties.kPCMCoo,
        c=sunampQ6MaterialProperties.cPCMCoo,
        d=sunampQ6MaterialProperties.dPCMCoo,
        TSol=sunampQ6MaterialProperties.TSolCoo,
        TLiq=sunampQ6MaterialProperties.TLiqCoo,
        LHea=sunampQ6MaterialProperties.LHeaCoo)),
